...
{
    /// <summary>
    /// Class is used for wrpper of RestClient
    /// </summary>
    public class RestClientWrapper
    {
        ...
        /// </summary>
        public async Task<RestResponse> DeleteAsync<T>(string resource, T body, Dictionary<string, string> headers = null)
        {
            var request = BuildRequest(resource, Method.Delete, body, headers);
            return await ExecuteWithRetryAsync(request);
        }
    }
}