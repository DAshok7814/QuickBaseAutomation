...
namespace QuickBase.TestAutomationSuite.TestCases
{
    [AllureNUnit]
    [TestFixture]
    public class DeleteRecordToProjectDataToQuickbase
    {
        /// <summary>
        ...
        [Test]
        public void TC_001_Successful_Request_DeleteRecord()
        {
            try
            {
                //Arrange
                ...
                {
                    var response = client?.DeleteAsync("", data, _headers).GetAwaiter().GetResult();
                    ...
                    JToken dataToken = jObject[Constants.ResponseData];

                    //Assert
                    Assert.That(queryResponse?.StatusCode, Is.EqualTo(HttpStatusCode.OK));
                    Assert.That(dataToken?.HasValues, Is.EqualTo(false));
                }
            }
            catch (Exception ex)
            {
        ...
        public void TC_002_Unauthorized_request_due_to_invalid_user_token()
        {
            ...
            {
                //Arrange
                var result = TestCaseUtility.Unauthorized_Request_DuetoInvalid_Usertoken(_headers, client,HttpMethod.Delete,Constants.TC_DataForProjectTable_Delete);
        ...
        public void TC_002_Unauthorized_request_due_to_missing_user_token()
        {
            ...
            {
                //Arrange & Act
                var result = TestCaseUtility.Unauthorized_Request_DuetoMissing_Usertoken(_headers, client, HttpMethod.Delete, Constants.TC_DataForProjectTable_Delete);
        ...
        public void TC_004_403_Forbidden()
        {
            ...
            {
                // Arrange
                var result = TestCaseUtility.Forbidden(_headers, client, HttpMethod.Delete);
                //Assert
        ...
        public void TC_007_405_Method_NotAllowed()
        {
            ...
            {
                //Arrange 
                var result = TestCaseUtility.Method_NotAllowed(_headers, client, HttpMethod.Delete);
